  ...
  public void runProgram(Scanner scanner) {
    ...
    while (true) {
      try {
        ...
        out.println("1. Обрахування простих вiдсоткiв");
        out.println("2. Обрахування складних вiдсоткiв");
        ...
        switch (userChoice) {
          ...
          default:
            // Invalid input
            out.println("Невiрний вибiр. Будь ласка, введiть коректний номер опцiї ");
        }
