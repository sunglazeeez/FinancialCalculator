...
public class Authorisation {
  ...
  public static boolean authenticate(String fileName) {
    ...
    try {
      ...
      out.println("Вхiд в облiковий запис");
      out.print("Введiть username: ");
      String enteredUsername = scanner.nextLine();

      // Checks for "exit" option
      if (enteredUsername.equalsIgnoreCase("вихiд")) {
        out.println("Вихiд з програми...");
        return false; // Exits the program
      }

      out.print("Введiть password: ");
      String enteredPassword = scanner.nextLine();

      // Checks for "exit" option
      if (enteredPassword.equalsIgnoreCase("вихiд")) {
        out.println("Вихiд з програми...");
        return false; // Exits the program
      }
