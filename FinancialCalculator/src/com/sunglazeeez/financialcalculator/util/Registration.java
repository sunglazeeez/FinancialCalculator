...
public class Registration {
  ...
  public void registration(String filePath) {
    try (Scanner scanner = new Scanner(in)) {
      ...
      out.println("Реєстрація облікового запису:");
      out.print("Напишіть username (name.name): ");
      String username = scanner.nextLine();
      out.print("Напишіть password (не меньше 8 символів): ");
      String password = scanner.nextLine();
      out.print("Напишіть email (name@gmail.com): ");
      String email = scanner.nextLine();
      out.print("Напишіть birthday (YYYY-MM-DD): ");
      LocalDate birthday = LocalDate.parse(scanner.nextLine());

      if (userAlreadyExists(users, email, username)) {
        out.println("Помилка: Користувач з такою ж адресою електронної пошти або ім'ям користувача вже існує ❗");
        return;
      }
      ...
      out.println("Помилка: Неправильний формат дати. Будь ласка, введіть дату у форматі YYYY-MM-DD ");
    }
  }
